...
# [1] "Pair"          "Sample_Type"   "Sample_ID"     "Contamination"
...
# <2% as good, and <5% as “warn”.
contamination_plot <- ggplot(data = contamination_data, aes(x = Sample_ID, y = Contamination, fill = Sample_Type)) +
    geom_bar(stat="identity") + 
    geom_hline(yintercept=2, color = "yellow") +
    geom_hline(yintercept=5, color = "red") +
    ylab("Percent") + 
    ggtitle("Percent Contamination") +
    coord_flip() +
    theme_bw()
...
- <2% contamination is considered good, and >5% contamination is considered a warning sign
