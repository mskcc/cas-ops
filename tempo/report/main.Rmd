...
child_docs <- c("overview.Rmd", "samples.Rmd", "qc.Rmd")
...
```{r calc_fig_heights}
# recalculate the default plot size based on the number of samples; default value is 7
...
if (nrow(pairing) > 20) {
    fig_height_normal <-  nrow(pairing) / 7
}

# height for longer plots
fig_height_long <- fig_height_normal * 3
```
